  ...
  const printReport = () => {
    ...
    printWindow.document.write(
      '<!doctype html><html lang="th"><head><meta charset="utf-8"><title>รายงานผลการดำเนินงานและแบบประเมินความพึงพอใจ</title>' +
        '<style>' +
        '@page{size:A4 portrait;margin:3.5mm 4mm 4.5mm}' +
        ...
        '.report{width:100%;max-width:none;min-height:0;display:flex;flex-direction:column;padding-bottom:6mm}.header{display:grid;grid-template-columns:minmax(220px,1fr) minmax(360px,1.35fr);gap:8px;align-items:center;padding:1px 0 3px;border-bottom:2px solid #123B6D}' +
