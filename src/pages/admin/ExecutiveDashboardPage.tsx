  ...
  const printReport = () => {
    ...
    printWindow.document.write(
      '<!doctype html><html lang="th"><head><meta charset="utf-8"><title>รายงานผลการดำเนินงานและแบบประเมินความพึงพอใจ</title>' +
        ...
        '.report{width:100%;max-width:none;min-height:286mm;display:flex;flex-direction:column;padding-bottom:4mm}.header{display:grid;grid-template-columns:minmax(220px,1fr) minmax(360px,1.35fr);gap:10px;align-items:center;padding:2px 0 5px;border-bottom:3px solid #123B6D}' +
        ...
        '.section{margin-top:3px}.activity-photo-panel{margin-top:7px}.activity-photo-panel .photo-grid-report{grid-template-columns:repeat(2,1fr);grid-auto-rows:1fr;min-height:96mm;gap:4px}.activity-photo-panel .photo-card{display:flex;min-height:0;flex-direction:column;overflow:hidden;border:1px solid #aaa;background:#fff}.activity-photo-panel .photo-card img{width:100%;height:auto;min-height:0;flex:1 1 auto;object-fit:cover}.section-title{font-size:14px;line-height:1.05;font-weight:800;margin:0 0 3px;padding:3px 7px;background:#123B6D;color:#fff;border-left:4px solid #C9A227;border-bottom:0}.meta-line{font-size:11px;margin:0 0 3px;color:#222}.meta-line span{display:inline-block;margin-right:16px}.meta-line strong{font-weight:800}' +
        ...
        '.audit-table{width:100%;border-collapse:collapse;font-size:12px}.audit-table th,.audit-table td{border:1px solid #aaa;padding:3px 5px}.audit-table th{background:#eee}.audit-check{text-align:center!important;width:38px}.signature-grid{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:8px}.signature-box{text-align:center;font-size:12px}.signature-line{height:17px;border-bottom:1px solid #333;margin:0 18px 2px}.seal-placeholder{display:inline-flex;width:40px;height:40px;border:1px solid #888;border-radius:50%;align-items:center;justify-content:center;font-size:8px;color:#666;margin-top:3px}.footer{margin-top:2px;padding-top:3px;border-top:1px solid #999;display:flex;justify-content:space-between;font-size:11px;color:#555}.avoid-break{break-inside:avoid;page-break-inside:avoid}@media print{html,body{width:auto;min-width:0;min-height:0;margin:0}.report{width:100%;max-width:none;min-height:0;padding-bottom:4mm}.section,.panel,.comments-photos,.grid-2,.bottom-grid{break-inside:auto;page-break-inside:auto}.photo-card{break-inside:avoid;page-break-inside:avoid}.footer{position:fixed;left:0;right:0;bottom:0;background:#fff;padding:2px 0;border-top:1px solid #111;z-index:10}}' +
