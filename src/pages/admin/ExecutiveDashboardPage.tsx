...
import {
  ...
  Download, ExternalLink, Filter, Image as ImageIcon, Printer, RefreshCw, RotateCcw,
  Search, Star, Users, X,
} from "lucide-react";
  ...
  const printReport = () => {
    ...
    printWindow.document.write(
      '<!doctype html><html lang="th"><head><meta charset="utf-8"><title>รายงานผลการดำเนินงานและแบบประเมินความพึงพอใจ</title>' +
        ...
        'body{margin:0;background:#fff;color:#111;font-size:10.5px;line-height:1.04}' +
        '.report{width:100%;min-height:0;display:flex;flex-direction:column;padding-bottom:7mm}.header{display:grid;grid-template-columns:minmax(220px,1fr) minmax(360px,1.35fr);gap:8px;align-items:center;padding:1px 0 3px;border-bottom:2px solid #123B6D}' +
        '.header-brand{display:flex;align-items:center;gap:7px;min-width:0}.logo{width:46px;height:46px;object-fit:contain;flex:0 0 auto}.brand-copy{text-align:left}.eyebrow{font-size:12px;font-weight:800;line-height:1.02;color:#111}.brand-sub{font-size:9.5px;font-weight:600;line-height:1.02;color:#333;margin-top:2px}.header-copy{text-align:right}.report-title{font-size:16px;line-height:1.02;font-weight:800;margin:0}.project-title{font-size:9.5px;font-weight:600;line-height:1.02;margin-top:2px}.org{display:none}' +
        '.section{margin-top:2px}.activity-photo-panel{margin-top:2px}.activity-photo-panel .photo-grid-report{grid-template-columns:repeat(2,1fr)}.section-title{font-size:11.5px;line-height:1.02;font-weight:800;margin:0 0 2px;padding:2px 6px;background:#123B6D;color:#fff;border-left:4px solid #C9A227;border-bottom:0}.meta-line{font-size:9.5px;margin:0 0 2px;color:#222}.meta-line span{display:inline-block;margin-right:16px}.meta-line strong{font-weight:800}' +
        '.kpis{display:grid;grid-template-columns:repeat(4,1fr);border:1px solid #C9A227;border-top:3px solid #123B6D}.kpi{padding:2px 4px;text-align:center;border-right:1px solid #aaa;background:#fff}.kpi:last-child{border-right:0}.kpi-label{font-size:8.5px;color:#444}.kpi-value{font-size:13px;font-weight:800;line-height:1.05;color:#123B6D}.kpi-unit{font-size:8.5px;font-weight:500}' +
        '.narratives{display:grid;grid-template-columns:1fr 1fr;gap:2px;margin-top:2px}.narrative{border:1px solid #C7D5E5;border-left:2px solid #2F7D4A;padding:2px 4px;background:#F7FBF8}.narrative strong{font-size:9.5px}.narrative p{font-size:9px;margin:1px 0 0;line-height:1.02;white-space:pre-line}.activity-details{margin-top:3px;border:1px solid #111;padding:3px;background:#fff}.activity-details-title{font-size:10px;font-weight:800;color:#123B6D;margin-bottom:2px;padding-bottom:2px;border-bottom:1px solid #111}.activity-details-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:3px}.activity-detail-card{border:1px solid #111;border-left:2px solid #123B6D;padding:2px 4px;background:#FAFAFA;min-height:0}.activity-detail-card strong{font-size:9px;color:#123B6D}.activity-detail-card p{font-size:8.5px;margin:1px 0 0;line-height:1.02;white-space:pre-line}.activity-detail-card:last-child{grid-column:auto}.filter-note{font-size:8px;color:#555;margin-top:2px}' +
        '.grid-2{display:grid;grid-template-columns:1fr 1fr;gap:8px}.panel{border:1px solid #aaa;padding:6px}.evaluation-overview{display:grid;grid-template-columns:76px 1.7fr 1fr;gap:3px;border:1px solid #aaa;padding:3px}.evaluation-score{display:flex;flex-direction:column;align-items:center;justify-content:center;border-right:1px solid #ccc;padding-right:5px}.evaluation-score span{font-size:8px;color:#555}.evaluation-score strong{font-size:19px;line-height:1;font-weight:800}.evaluation-score small{font-size:8px}.evaluation-note>strong,.evaluation-distribution>strong{font-size:8.5px;display:block;margin-bottom:2px}.rating-compact .rating-row{margin-bottom:1px}.rating-compact .rating-head{font-size:8.5px}.rating-compact .rating-head strong{font-size:8.5px}.rating-compact .bar-track{height:3px}.dist-row{display:grid;grid-template-columns:40px 1fr 22px;gap:3px;align-items:center;font-size:8px;margin-bottom:1px}.dist-track{height:3px;background:#e8e8e8}.dist-fill{height:100%;background:#123B6D}.dist-row strong{text-align:right}.score-detail-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:3px;margin-top:3px}.score-group-card{border:1px solid #C7D5E5;border-top:2px solid #2F7D4A;padding:3px;background:#FBFDFC}.score-group-title{display:flex;justify-content:space-between;gap:3px;border-bottom:1px solid #D7DCE2;padding-bottom:1px;margin-bottom:1px;font-size:9px;font-weight:800;color:#123B6D}.score-group-title strong{font-size:8.5px}.detail-score-row{margin-bottom:1px}.detail-score-head{display:flex;justify-content:space-between;font-size:8px;gap:3px}.detail-score-head strong{font-size:8px}.detail-score-row .bar-track{height:2px}.detail-score-row small{display:block;font-size:7px;color:#666;margin-top:0}.rating-row{margin-bottom:6px}.rating-head{display:flex;justify-content:space-between;gap:6px;font-size:14px}.rating-head strong{font-size:14px}.bar-track{height:7px;background:#e5e5e5;margin-top:2px}.bar-fill{height:100%;background:#123B6D}.subhead{font-size:14px;font-weight:800;margin-bottom:2px}.stat-line{display:flex;justify-content:space-between;border-bottom:1px dotted #bbb;padding:2px 0;font-size:13px}.stat-line small{font-size:11px;color:#555}.empty{font-size:13px;color:#777;padding:4px 0}.chart-row{display:grid;grid-template-columns:72px 1fr 48px;align-items:center;gap:5px;margin-bottom:5px;font-size:12px}.chart-label{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.chart-track{height:9px;background:#e8e8e8;border-radius:2px;overflow:hidden}.chart-fill{height:100%;background:#222}.chart-value{text-align:right;font-weight:800}.mini-donut{display:grid;grid-template-columns:92px 1fr;gap:8px;align-items:center}.donut{width:82px;height:82px;border-radius:50%;background:conic-gradient(#222 0 42%,#777 42% 80%,#bbb 80% 100%);position:relative}.donut:after{content:"";position:absolute;inset:18px;border-radius:50%;background:#fff}.legend-item{display:flex;justify-content:space-between;gap:5px;border-bottom:1px dotted #bbb;padding:2px 0;font-size:12px} .respondent-donuts{display:grid;grid-template-columns:1fr 1fr;gap:3px}.donut-card{border:1px solid #B9C7D8;border-top:2px solid #C9A227;padding:3px;background:linear-gradient(135deg,#F4F8FD 0%,#FFFFFF 58%,#F1F8F3 100%)}.donut-card-title{font-size:9px;font-weight:800;color:#123B6D;margin-bottom:5px;border-left:3px solid #2F7D4A;padding-left:6px}.donut-panel{display:grid;grid-template-columns:68px 1fr;gap:3px;align-items:center}.donut-wrap{width:62px;height:62px;position:relative}.report-donut{width:62px;height:62px;display:block}.donut-center{position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center}.donut-center strong{font-size:10px;line-height:1;font-weight:800;color:#123B6D}.donut-center span{font-size:7px;color:#555;margin-top:2px}.donut-legend{min-width:0}.donut-legend-row{display:flex;justify-content:space-between;align-items:center;gap:4px;border-bottom:1px dotted #C7CDD4;padding:1px 0;font-size:8.5px}.donut-legend-row:last-child{border-bottom:0}.donut-legend-label{display:flex;align-items:center;gap:5px;min-width:0}.donut-legend-label i{display:inline-block;width:8px;height:8px;border-radius:50%;flex:0 0 auto}.donut-legend-row strong{white-space:nowrap}.donut-legend-row small{font-size:7px;color:#666;font-weight:500}.photo-grid-report{display:grid;grid-template-columns:repeat(2,1fr);gap:3px}.photo-inline-title{margin-top:5px;padding-top:3px;border-top:2px solid #C9A227;font-size:14px;font-weight:800;color:#2F7D4A}.respondent-photo-section{background:linear-gradient(135deg,#F8FBFF 0%,#FFFFFF 55%,#F3FAF5 100%)}.photo-card img{height:50px}.comments-photos{display:grid;grid-template-columns:1fr 1.1fr;gap:8px}' +
        '.comments-photos{display:grid;grid-template-columns:1fr 1fr;gap:8px}.comment-item{display:grid;grid-template-columns:22px 1fr;gap:6px;padding:4px 0;border-bottom:1px solid #ddd}.comment-number{width:19px;height:19px;border:1px solid #333;border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:11px}.comment-item p{margin:0;font-size:13px;line-height:1.3}.comment-item small{font-size:11px;color:#555}.photos{display:grid;grid-template-columns:1fr 1fr;gap:6px}.photo-card{margin:0}.photo-card img{width:100%;height:92px;object-fit:cover;border:1px solid #aaa;display:block}.photo-card figcaption{font-size:7px;margin-top:1px;text-align:center;color:#444}.photo-empty{height:92px;border:1px dashed #aaa;display:flex;align-items:center;justify-content:center;font-size:12px;color:#777}' +
        ...
        '.audit-table{width:100%;border-collapse:collapse;font-size:12px}.audit-table th,.audit-table td{border:1px solid #aaa;padding:3px 5px}.audit-table th{background:#eee}.audit-check{text-align:center!important;width:38px}.signature-grid{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:8px}.signature-box{text-align:center;font-size:12px}.signature-line{height:17px;border-bottom:1px solid #333;margin:0 18px 2px}.seal-placeholder{display:inline-flex;width:40px;height:40px;border:1px solid #888;border-radius:50%;align-items:center;justify-content:center;font-size:8px;color:#666;margin-top:3px}.footer{margin-top:auto;padding-top:2px;border-top:1px solid #999;display:flex;justify-content:space-between;font-size:8.5px;color:#555}.avoid-break{break-inside:avoid;page-break-inside:avoid}@media print{html,body{width:210mm;min-height:297mm}.report{min-height:0;padding-bottom:7mm}.section,.panel,.comments-photos,.grid-2,.bottom-grid{break-inside:auto;page-break-inside:auto}.photo-card{break-inside:avoid;page-break-inside:avoid}.footer{position:fixed;left:0;right:0;bottom:0;background:#fff;padding:2px 0;border-top:1px solid #111;z-index:10}}' +
