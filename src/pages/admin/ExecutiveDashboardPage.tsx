  ...
  const printReport = () => {
    ...
    printWindow.document.write(
      '<!doctype html><html lang="th"><head><meta charset="utf-8"><title>รายงานผลการดำเนินงานและแบบประเมินความพึงพอใจ</title>' +
        ...
        '.report{width:100%;max-width:none;min-height:286mm;display:flex;flex-direction:column;padding-bottom:2mm}.header{display:grid;grid-template-columns:minmax(220px,1fr) minmax(360px,1.35fr);gap:10px;align-items:center;padding:2px 0 5px;border-bottom:3px solid #123B6D}' +
        ...
        '.section{margin-top:3px}.activity-photo-panel{margin-top:4px}.activity-photo-panel .photo-grid-report{grid-template-columns:repeat(2,1fr);grid-template-rows:repeat(2,1fr);height:72mm;min-height:72mm;gap:4px}.activity-photo-panel .photo-card{display:flex;min-height:0;flex-direction:column;overflow:hidden;border:1px solid #aaa;background:#fff}.activity-photo-panel .photo-card img{width:100%;height:auto;min-height:0;flex:1 1 auto;object-fit:cover}.section-title{font-size:14px;line-height:1.05;font-weight:800;margin:0 0 3px;padding:3px 7px;background:#123B6D;color:#fff;border-left:4px solid #C9A227;border-bottom:0}.meta-line{font-size:11px;margin:0 0 3px;color:#222}.meta-line span{display:inline-block;margin-right:16px}.meta-line strong{font-weight:800}' +
