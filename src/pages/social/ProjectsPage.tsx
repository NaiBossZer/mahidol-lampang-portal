      ...
      <div className="bg-surface-warm">
        <section className="bg-brand-navy text-white" aria-labelledby="projects-title">
          <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
            ...
            <h1 id="projects-title" className="mt-4 text-3xl font-black sm:text-4xl">
              โครงการเพื่อสังคม
            </h1>
    ...
    <PublicAppShell>
      <div className="bg-surface-warm">
        <section className="bg-brand-navy text-white" aria-labelledby="project-detail-title">
          <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
            ...
            <h1
              ...
              className="mt-5 max-w-4xl text-3xl font-black sm:text-4xl"
            >
              {project.title}
            </h1>
        ...
        <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          >
            <h2 id="project-role-title" className="text-xl font-black text-brand-navy">
              บทบาทของโครงการ
            </h2>
