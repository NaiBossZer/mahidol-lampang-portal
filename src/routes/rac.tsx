...
export const Route = createFileRoute('/rac')({
  component: RACFallback,
});

function RACFallback() {
  return (
    <div className="w-full h-screen flex flex-col">
      <div className="bg-yellow-100 text-yellow-800 p-2 text-center text-sm font-medium">
        ...
        <a href="https://rac-sub.vercel.app" target="_blank" rel="noreferrer" className="underline ml-1">
          https://rac-sub.vercel.app
        </a>
        ผ่าน Iframe (บน Production จะใช้งานผ่าน Vercel Rewrites)
      </div>
      <iframe 
        src="https://rac-sub.vercel.app" 
