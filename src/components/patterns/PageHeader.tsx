    ...
    <header className={cn("border-b border-border bg-white", className)}>
      <div className="container-content flex flex-col gap-5 py-8 sm:py-10 lg:flex-row lg:items-end lg:justify-between">
        <div className="min-w-0">
          ...
          <h1 className="mt-2 text-balance text-3xl font-black leading-tight text-brand-navy sm:text-4xl">{title}</h1>
          {description && <p className="mt-3 max-w-3xl text-sm leading-7 text-muted-ink sm:text-base">{description}</p>}
        </div>
