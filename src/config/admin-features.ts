...
{ id:"surveys",label:"แบบสอบถาม",area:"operations",status:"foundation",route:"/admin/surveys",permission:"survey.read",children:["survey-question-builder","survey-responses","survey-analytics"] },
{ id:"survey-question-builder",label:"ตัวสร้างคำถาม",area:"operations",status:"foundation",permission:"survey.create" },
