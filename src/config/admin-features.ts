...
export const ADMIN_FEATURES: readonly AdminFeatureDefinition[] = [
  ...
  // Domain 2 — กิจกรรม: one operational entry point; related data is managed inside the activity.
  {
    ...
    children: ["activity-occurrences", "activity-photos", "activity-relations"],
  },
  {
    id: "activity-occurrences",
    label: "รอบการจัดกิจกรรม",
    area: "activities",
    status: "foundation",
    route: "/admin/activities/occurrences",
    permission: "activities.read",
  },
  {
    id: "activity-photos",
  ...
  {
    id: "activity-relations",
    label: "ข้อมูลที่เกี่ยวข้องของกิจกรรม",
    area: "activities",
    status: "foundation",
    permission: "activities.read",
  },
  ...
  // Domain 3 — Engagement & Insights
  {
    ...
    children: ["survey-question-builder", "survey-responses", "survey-analytics"],
  },
  {
    id: "survey-question-builder",
    label: "ตัวสร้างคำถาม",
    area: "engagement",
    status: "foundation",
  ...
  },
  {
    ...
    area: "engagement",
    status: "foundation",
    route: "/admin/surveys/response",
    permission: "survey.audit.read",
  },
  {
    id: "survey-analytics",
    label: "วิเคราะห์แบบสอบถาม",
    area: "engagement",
    status: "foundation",
    route: "/admin/surveys/analytics",
    permission: "survey.audit.read",
  },
  {
    id: "analytics",
  ...
  },
  {
    ...
    area: "engagement",
    status: "foundation",
    route: "/admin/governance?tab=reports",
    permission: "overview.read",
  },
  ...
  },
  {
    ...
    area: "core",
    status: "foundation",
    route: "/admin/governance?tab=users",
  ...
  },
  {
    ...
    area: "core",
    status: "foundation",
    route: "/admin/governance?tab=lifecycle",
    permission: "system.manage",
  },
  {
    id: "global-search",
    ...
    area: "core",
    status: "foundation",
    route: "/admin/governance?tab=search",
    permission: "overview.read",
  },
  {
    id: "notifications",
