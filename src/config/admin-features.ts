...
export type AdminFeatureArea="core"|"operations"|"insights"|"ai"|"governance";export type AdminFeatureStatus="foundation"|"planned"|"future";export interface AdminFeatureDefinition{id:string;label:string;area:AdminFeatureArea;status:AdminFeatureStatus;route?:string;permission?:AdminPermission;children?:readonly string[]}
...
{id:"activity-photos",label:"ภาพกิจกรรม",area:"operations",status:"foundation",route:"/admin/activities/photos",permission:"activities.read"},
...
{id:"survey-responses",label:"คำตอบแบบสอบถาม",area:"operations",status:"foundation",route:"/admin/surveys/response",permission:"survey.audit.read"},
...
{id:"reports",label:"Reports",area:"insights",status:"foundation",route:"/admin/governance",permission:"overview.read"},
{id:"global-search",label:"Global Search",area:"core",status:"foundation",route:"/admin/governance",permission:"overview.read"},
{id:"notifications",label:"Notifications",area:"core",status:"foundation",route:"/admin/governance",permission:"overview.read"},
{id:"ai-tool-registry",label:"AI Tool Registry",area:"ai",status:"foundation",route:"/admin/governance",permission:"ai.command.read"},
{id:"ai-manager",label:"AI Manager",area:"ai",status:"foundation",route:"/admin/governance",permission:"ai.command.read"},
...
{id:"admin-users",label:"Admin Users",area:"governance",status:"foundation",route:"/admin/governance",permission:"system.manage"},
{id:"permissions",label:"Permissions",area:"governance",status:"foundation",route:"/admin/governance",permission:"system.manage"},
{id:"audit-trail",label:"Audit Trail",area:"governance",status:"foundation",route:"/admin/audit-trail",permission:"system.read"},
{id:"data-lifecycle",label:"Data Lifecycle",area:"governance",status:"foundation",route:"/admin/governance",permission:"system.manage"},
