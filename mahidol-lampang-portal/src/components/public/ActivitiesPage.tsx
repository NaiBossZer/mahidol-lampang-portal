...
const allActivities = [
  {
    ...
    category: "เกษตร",
    tag: "#5F8D62",
    title: "เปิดรับสมัครนักเรียนฝึกงาน Smart Farm 2567",
    date: "15 ก.ย. 2567",
    location: "ศูนย์เกษตรอัจฉริยะ",
    image:
      "https://images.unsplash.com/photo-1560559383-338dc7faf062?w=600&h=380&fit=crop&auto=format",
  },
  {
    id: 2,
    category: "วัฒนธรรม",
    tag: "#C66B4F",
    title: "Workshop ภูมิปัญญาครั่ง กับ Shellac Learning Center",
    date: "22 ก.ย. 2567",
    location: "SLC อาคาร B",
    image:
      "https://images.unsplash.com/photo-1647879826700-cfc5fd9d9a31?w=600&h=380&fit=crop&auto=format",
  },
  {
    id: 3,
    category: "พลังงาน",
    tag: "#1677A8",
    title: "เปิดตัวระบบโซลาร์เซลล์ชุมชน ลดคาร์บอน 40%",
    date: "30 ก.ย. 2567",
    location: "ลานกิจกรรมกลาง",
    image:
      "https://images.unsplash.com/photo-1711397651462-3b2a22f5cfc8?w=600&h=380&fit=crop&auto=format",
  },
  {
    id: 4,
    category: "การศึกษา",
    tag: "#123B63",
    title: "สัมมนาวิชาการ: นวัตกรรมการศึกษาในยุค AI",
    date: "5 ต.ค. 2567",
    location: "ห้องประชุมใหญ่",
    image:
      "https://images.unsplash.com/photo-1708454567006-c020cda64b36?w=600&h=380&fit=crop&auto=format",
  },
  {
    id: 5,
    category: "ชุมชน",
    tag: "#D6A84F",
    title: "ตลาดชุมชนออร์แกนิก ครั้งที่ 12",
    date: "12 ต.ค. 2567",
    location: "ลานกิจกรรมกลาง",
    image:
      "https://images.unsplash.com/photo-1647607124632-f47bfa887125?w=600&h=380&fit=crop&auto=format",
  },
  {
    id: 6,
    category: "วิจัย",
    tag: "#5F8D62",
    title: "นำเสนอผลงานวิจัยด้านสิ่งแวดล้อมลำปาง 2567",
    date: "20 ต.ค. 2567",
    location: "ห้อง Conference 1",
    image:
      "https://images.unsplash.com/photo-1731865746818-9c6dbbc52c72?w=600&h=380&fit=crop&auto=format",
  },
];
    ...
    <div>
      ...
      <div className="bg-white border-b border-[#EEE9DF]">
        <div className="max-w-[1280px] mx-auto px-8 max-md:px-4 py-10">
          <nav
            className="flex items-center gap-2 text-sm text-[#667085] mb-4"
      ...
      <div className="max-w-[1280px] mx-auto px-8 max-md:px-4 py-10">
        ...
        {filtered.length > 0 && (
          <div className="flex items-center justify-center gap-2 mt-12">
            <button
              className="w-10 h-10 rounded-lg border border-[#EEE9DF] flex items-center justify-center text-[#667085] hover:border-[#123B63]/30 hover:text-[#123B63] transition-colors disabled:opacity-40"
              disabled
            >
              <ChevronLeft size={16} />
            </button>
